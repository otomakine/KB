...
- + a lot of interesting things, sorting, auto-reports, gates with api requests, scripting frameworks and pipes,etc others also did aome interesting things, i was a hero but not alone, dev had their own srv and iscala also monitored their installation only, results were stored on my portals, a lot of portals but now all in ruins, most worked many years in row, 15-23, some fucntions were used in pipe gates, i would change that
